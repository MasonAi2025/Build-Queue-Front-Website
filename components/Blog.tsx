...
const blogPosts = [
  {
    ...
    link: "/guides/choosing-your-first-mes",
  },
  {
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <NeuCard key={index} className="p-6 flex flex-col group">
                <Link to={post.link} className="flex flex-col flex-grow">
                    ...
                    <div className="flex items-center gap-2 text-neu-teal font-semibold mt-4 group-hover:underline">
